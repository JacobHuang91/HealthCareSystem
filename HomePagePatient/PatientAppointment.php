        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link waves-effect " href="PatientProfile.php">Profile</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link waves-effect" href="#">Appointment</a>
                    </li>
                </ul>
                ...
                <div class="col-6 offset-3">
                    ...
                    <form action="ProcessAppointment.php" method="post">
                        <div class="form-group" style="display: none">
                            <input type="text" class="form-control" name="patientId" value="<?php echo $_SESSION['user']['ID']?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="doctors" name="doctorId">
                                <?php
                                foreach ($rows as $row):
                                ?>
                                    <option value=<?php
